...
<body>
  <div class="container">
    ...
    <h2>Edição de Livro</h2><br>
    <form action="edicao_livro.php" method="POST">
      <div class="form-group">
        <label>Novo nome do Livro:</label>
        <input type="text" id="nome_livro" name="nome_livro" placeholder="Digite o nome do Livro:" required style="width: 260px;">
      </div>
      <div class="form-group">
        <label>Novo ano do Livro:</label>
        <input type="text" id="ano_publicacao" name="ano_publicacao" placeholder="Digite o Ano do Livro:" required style="width: 260px;">
      </div>
      
      <div class="mb-3">
        <label for="disabledSelect" class="form-label">Livro</label>
